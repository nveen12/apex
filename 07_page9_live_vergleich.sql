...
begin
    ...
    wwv_flow_imp_page.create_report_region(
        ...
        p_source                     => wwv_flow_string.join(wwv_flow_t_varchar2(
            ...
            'from   data',
            'union all',
            'select ''Keine Objekte fuer Schema '' || upper(:P9_SCHEMA_NAME), 0, 0, ''INFO''',
            'from   dual',
    ...
    wwv_flow_imp_page.create_report_region(
        ...
        p_source                     => wwv_flow_string.join(wwv_flow_t_varchar2(
            ...
            'from   data',
            'union all',
            'select ''Keine Tabellen fuer Schema '' || upper(:P9_SCHEMA_NAME), 0, 0, ''INFO''',
            'from   dual',
            'where  not exists (select 1 from data)',
            'order by 1')),
        p_display_when_condition      => 'P9_COMPARE_OK',
    ...
    wwv_flow_imp_page.create_report_region(
        ...
        p_source                     => wwv_flow_string.join(wwv_flow_t_varchar2(
            ...
            'from   data',
            'union all',
            'select null, ''Keine APEX-Anwendung fuer Workspace/Schema '' || upper(:P9_SCHEMA_NAME),',
